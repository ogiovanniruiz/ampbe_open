const convertQueriesIndividual = async(queries) =>{
    ...
    const mapRule = (rule) =>{
        ...
        if(field === 'party'){
            ...
            return {['resident.tags.'+ value]: true}
...
module.exports = {convertQueriesIndividual}
