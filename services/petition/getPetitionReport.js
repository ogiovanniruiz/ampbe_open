...
const PetitionContactHistory = require('../../models/activities/petition/petitionContactHistory');
const ObjectId = mongoose.Types.ObjectId;

const getPetitionReport = async(detail) => {
    try {
        ...
        var report = await PetitionContactHistory.aggregate(agg).allowDiskUse(true);
...
module.exports = {getPetitionReport}
