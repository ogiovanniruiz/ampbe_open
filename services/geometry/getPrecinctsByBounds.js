...
const getPrecinctsByBounds = async(detail) => {
    try {
        ...
        return await Precincts.find({ geometry: {$geoIntersects: { $geometry: {type: "Polygon" , coordinates: [arrayCoords] }}} });
    } catch(e){
        throw new Error(e.message)
    }
}

module.exports = {getPrecinctsByBounds}
