...
const getPrecBlockReport = async(detail) => {
    try {
        ...
        if (detail.data.selectedReportType === 'Blockgroup') {
            var selectedReportType = '$outReachReport.person.blockgroupID';
        }

        if (detail.data.selectedReportType === 'Precinct') {
            var selectedReportType = '$outReachReport.person.precinctID';
        }
...
module.exports = {getPrecBlockReport}
